...
const CouponEditForm = ({ coupon }: CouponEditFormProps) => {
    const router = useRouter();

    const [code, setCode] = useState(coupon.code);
    const [type, setType] = useState<DiscountType>(coupon.type);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <section className="rounded-2xl border border-border bg-white p-5 shadow-sm sm:p-8">
                <div className="mb-6">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        Update the coupon code and discount settings.
                    </p>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="mt-2 text-xs text-gray-400">
                            Coupon codes are stored in uppercase.
                        </p>
                    </div>
            ...
            <section className="rounded-2xl border border-border bg-white p-5 shadow-sm sm:p-8">
                <div className="mb-6">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                        Adjust optional restrictions and usage limits.
                    </p>
                </div>
            ...
            <section className="rounded-2xl border border-border bg-white p-5 shadow-sm sm:p-8">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Control whether this coupon can currently be used.
                        </p>
                    </div>
